...
class AccountTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_type" do
    assert_difference('AccountType.count') do
      post account_types_url, params: { account_type: { available_mediums: @account_type.available_mediums, is_active: @account_type.is_active, name: @account_type.name } }, as: :json
    end
  ...
  test "should update account_type" do
    patch account_type_url(@account_type), params: { account_type: { available_mediums: @account_type.available_mediums, is_active: @account_type.is_active, name: @account_type.name } }, as: :json
    assert_response 200
  end
